 ...
 */
package org.apache.zookeeper.common.metrics;

import org.apache.zookeeper.common.Reconfigurable;
import org.apache.zookeeper.common.annotation.InterfaceStability;
 ...
 * <p>
 * Implement {@link org.apache.zookeeper.common.ClusterResourceListener} to receive cluster metadata once it's available. Please see the class documentation for ClusterResourceListener for more information.
 */
public interface MetricsReporter extends Reconfigurable, AutoCloseable {
    ...
    void contextChange(org.apache.zookeeper.common.metrics.MetricsContext metricsContext);
}
